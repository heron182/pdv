...
snapshots["test_create_pdv_duplicate_document 1"] = {
    ...
    "errors": [
        {
            "locations": [{"column": 13, "line": 2}],
            "message": 'Tried to save duplicate unique keys (E11000 duplicate key error collection: pdv_test.pdv index: document_1 dup key: { : "18.846.988/6387-60" })',
            "path": ["createPdv"],
        }
    ],
}
...
snapshots["test_find_pdv 1"] = {"data": {"allPdvs": {"edges": []}}}
